# Kubernetes Principles Reference

This reference contains the full generated rule set. Load it only when the active checklist in SKILL.md is not enough for the task.
