...
Agentic Principles ships 130+ actionable rules across 9 technology categories. Drop it into any repo and it automatically detects your stack, loads the relevant principles, and sets up pre-commit formatting and linting — zero config required.
...
- **Auto-detecting** your tech stack (Python, Go, Rust, Node.js, Terraform, K8s, Ansible, Shell)
